...
public class ClassicChance implements CardBuilder{
	...
	public LinkedList<Card> getCards(Game game) {
		...
		cards.add(new Card(new GoToStrategy(0, true),"photosCartes/chance1","",game)); 
		cards.add(new Card(new GoToStrategy(24, true),"photosCartes/chance2","",game)); 
		...
		cards.add(new Card(new GoToStrategy(15, true),"photosCartes/chance7","",game)); 
		...
		cards.add(new Card(new GoToStrategy(11, true),"photosCartes/chance16","",game)); 
