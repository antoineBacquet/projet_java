...
public class ClassicCommu implements CardBuilder {
	...
	public LinkedList<Card> getCards(Game game) {
		...
		cards.add(new Card(new PaidMoneyStrategy(500000),"photosPlateau/chance","Payez un week-end de thalasso dans un hôtel 5 étoiles 500 000 €.",game)); 
		...
		cards.add(new Card(new PaidMoneyStrategy(100000),"photosPlateau/chance","Payez une contravention de 100 000 € ou bien tirez une carte Chance.",game)); 
